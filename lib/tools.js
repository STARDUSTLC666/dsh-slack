...
export function buildHealthTool(deps) {
    return {
        name: 'slack_health',
...
export function buildNotifyTool(deps) {
...
export function buildChannelsTool(deps) {
    const parameters = compileParameters({});
    const output = {
...
export function buildInboxTool(deps) {
    const parameters = compileParameters({
...
export function buildReplyTool(deps) {
    const parameters = compileParameters({
